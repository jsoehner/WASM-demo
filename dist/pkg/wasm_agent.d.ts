...
export class Agent {
    free(): void;
    [Symbol.dispose](): void;
    constructor(api_url: string, api_key: string, provider: string);
    run_task(model: string, prompt: string): Promise<any>;
}
...
export interface InitOutput {
    ...
    readonly agent_new: (a: number, b: number, c: number, d: number, e: number, f: number) => number;
    readonly agent_run_task: (a: number, b: number, c: number, d: number, e: number) => any;
