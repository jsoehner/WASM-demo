...
export class Agent {
     ...
     */
    constructor(api_url, api_key, provider) {
        ...
        const ret = wasm.agent_new(ptr0, len0, ptr1, len1, ptr2, len2);
    ...
    run_task(model, prompt) {
        ...
        const len1 = WASM_VECTOR_LEN;
        const ret = wasm.agent_run_task(this.__wbg_ptr, ptr0, len0, ptr1, len1);
        return ret;
    }
}
